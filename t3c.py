...
This is implementation of :rfc:`5830` ECB, CNT, CFB, MAC and :rfc:`4357`
...
class MAC(object):
    ...
    'a687a08b'
    """
    def __init__(self, key, iv=8 * b'\x00', sbox=DEFAULT_SBOX):
        """
...
pt = hexdec("cacaaaaa".encode("utf-8").hex())
